    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                <ul class="nav navbar-nav">
                    @foreach( getCategoriesForNaviBar() as $item )
                        <li class="{{ active_class((if_route('categories.show') && if_route_param('category', $item->id))) }}"><a href="{{ route('categories.show', $item->id) }}">{{ $item->name }}</a></li>
                    @endforeach
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <span class="user-avatar pull-left" style="margin-right:8px; margin-top:-5px;">
                                <img src="{{ Auth::user()->avatar??'https://fsdhubcdn.phphub.org/uploads/images/201709/20/1/PtDKbASVcz.png?imageView2/1/w/60/h/60'}}" class="img-responsive img-circle" width="30px" height="30px">
                            </span>
