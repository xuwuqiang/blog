...
<div id="text">
    ...
    <p>Uh oh, I couldn't find a link for the bitly URL you clicked.</p>
...
<ul class="bottomLinkList">
    ...
    {{--<li><a href="https://bitly.com/">Home</a></li>--}}
    {{--<li><a href="mailto:support@bitly.com">Contact Us</a></li>--}}
    <li class="copy">&copy; <span class='year'></span> Lockiee <span class="tm">TM</span></li>
</ul>
